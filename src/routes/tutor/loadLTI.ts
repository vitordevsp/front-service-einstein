...
export async function tutorLoadLTIRoute(app: FastifyInstance) {
  app.post('/tutor/load-lti', async (req: FastifyRequest, reply: FastifyReply) => {
    try {
      ...
      console.error('ERROR | loadLTIRoute | post | /tutor/load-lti: ', appError)
